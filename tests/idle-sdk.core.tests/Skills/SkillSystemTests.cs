...
public class SkillSystemTests
{
    ...
    public void SkillProgress_Levels_Up_When_Xp_Reaches_Threshold()
    {
        ...
        registry.Register(new SkillDefinition("mining", "Mining", "⛏️", 5, new Dictionary<int, string>()));
    ...
    {
        var registry = new SkillRegistry();
        registry.Register(new SkillDefinition("combat", "Combat", "⚔️", 2, new Dictionary<int, string>()));
    ...
    [Fact]
    public void SkillProgress_Tracks_Unlocks()
    {
        var registry = new SkillRegistry();
        registry.Register(new SkillDefinition("crafting", "Crafting", "🛠️", 3, new Dictionary<int, string>
        {
            [2] = "Bronze",
            [3] = "Iron"
        }));
        ...
        system.AddXp("crafting", 20);

        var progress = system.GetOrCreateProgress("crafting");
